window.app.controller("SignInPage", ['$scope', '$http', '$window', 'Site', 'Messaging',
  function($scope, $http, $window, $site, $msg) {
    "use strict";
    ...
    $scope.attemptSignIn = function() {
      $scope.$site.signIn(function(data) {
